...
with col1:
    st.image("anaemia-during-pregnancy_m.jpg", width=400)  
...
with col2:
    ...
    if user_input.strip():
        ...
        st.info("This chatbot provides educational health guidance. Always consult a doctor for medical concerns.")
